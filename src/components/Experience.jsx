...
const experiences = [
  ...
  },
  {
    ...
    tech: ["Next.js", "TypeScript", "Supabase", "PostgreSQL", "Gemini API", "Zod", "Recharts", "Vercel", "Cloudflare Turnstile"],
    bullets: [
      ...
      "Integrated Cloudflare Turnstile bot protection into the authentication flow to mitigate automated login/registration abuse.",
