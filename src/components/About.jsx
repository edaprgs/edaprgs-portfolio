...
export default function About() {
  return (
    <section id="about" className="ide-section">
      ...
      <motion.div {...fade(0.5)} className="about-tldr">
        <div className="about-tldr-head">
          <div className="about-tldr-icon">
            <Sparkles size={14} />
          </div>
          <div>
            <p className="about-tldr-label">TL;DR</p>
            <p className="about-tldr-body">
        ...
        <div className="about-tldr-chips">
          {["Cum Laude", "Remote-first", "Open to work", "3,000+ records"].map(chip => (
            <span key={chip} className="about-tldr-chip">{chip}</span>
          ))}
        </div>
      </motion.div>
